...
> [!CAUTION]
> Building web applications with pure HTML forms could potentially expose your application to Cross-Site Request Forgery (CSRF) attacks. For more information, please refer to our documentation pertaining to [CSRF Protection](../0076Trongate_MX_Security/0079csrf_protection.md).
