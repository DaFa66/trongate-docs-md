...
![Example responsive image](https://dafadev.net/a1/images/dragon.webp)
```html
...
![Left aligned image](https://dafadev.net/a1/images/horse.webp)
![Right aligned image](https://dafadev.net/a1/images/horse.webp)
![Center aligned image](https://dafadev.net/a1/images/horse.webp)
```html
<!-- Left aligned image -->
...
![Grid image 1](https://dafadev.net/a1/images/lion.webp)![Grid image 2](https://dafadev.net/a1/images/lion.webp)![Grid image 3](https://dafadev.net/a1/images/lion.webp)
```html
...
![Card image example](https://dafadev.net/a1/images/falcon.webp)Images automatically fit within card boundaries while maintaining their aspect ratio.
```html
<div class="card">
