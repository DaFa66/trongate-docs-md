...
The Trongate framework includes a built-in [Pagination class](../../reference/class_reference/The_Pagination_Class) for generating numbered navigation links when displaying multiple pages of content. Below is an example of the pagination output generated by Trongate:



    ![screenshot](https://dafadev.net/a1/images/32/paginatiVwds.png)
