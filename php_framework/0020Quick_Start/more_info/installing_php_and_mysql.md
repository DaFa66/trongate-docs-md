...
You can download a copy of XAMPP from [here](https://www.apachefriends.org/download.html).


**Mac Users:** The makers of XAMPP have produced a "VM machine" and it has caused a little confusion for Mac developers. So, if you're a Mac user then there's a video for you that walks you through the whole XAMPP setup. The URL is: [https://youtu.be/L2X6fDiqOC4](https://youtu.be/L2X6fDiqOC4)?
